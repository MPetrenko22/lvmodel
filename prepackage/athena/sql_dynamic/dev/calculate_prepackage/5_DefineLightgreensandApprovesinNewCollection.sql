...
with LG_TIT as (
	...
	from lvmodel_dev.m_pre_itbf_contact_new_collection_? nc
...
from lvmodel_dev.m_pre_itbf_contact_new_collection_? n
...
/* Skip Demands */
merge into lvmodel_dev.m_pre_itbf_approved_new_collection_? n
using (
			select distinct k.list_id, k.a_state, k.a_employee 
			from lvmodel_dev.m_pre_itbf_campaign_demand_mask_? k
			where k.list_id = ?
		) m
...
update  lvmodel_dev.m_pre_itbf_approved_new_collection_?
