...
delete from lvmodel_stage.m_pre_itbf_contact_history_table;


/* Load contact history datea */
insert into lvmodel_stage.m_pre_itbf_contact_history_table
WITH CC AS (
...
UPDATE lvmodel_stage.m_pre_itbf_contact_history_table 
SET "value" = 'USA'
...
delete from lvmodel_stage.m_pre_itbf_pv_history;


/* Load PV history */
insert into lvmodel_stage.m_pre_itbf_pv_history
with CON as (
	select distinct ext_entity_id as ext_contact_id
	from lvmodel_stage.m_pre_itbf_contact_history_table h
...
delete from lvmodel_stage.m_pre_itbf_approve_history ;


/* Load Approve history */
insert into lvmodel_stage.m_pre_itbf_approve_history 
with 
APR_TIT as (
