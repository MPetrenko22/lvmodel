...
drop table lvmodel.m_pre_itbf_final ;

CREATE TABLE lvmodel.m_pre_itbf_final (
		cid string, 
		list_id int, 
		session_id int,
		email string, 
...
CREATE TABLE lvmodel.m_pre_itbf_industry_dict (
	industry string,
	sub_industry string
)
location 's3://lvprepackage-eu/iceberg/'
...
CREATE TABLE lvmodel.m_pre_itbf_pv_history (
	ext_contact_id bigint,
	contact_id bigint,
	pv_comment string,
	contact_phone string,
...
CREATE TABLE lvmodel.m_pre_itbf_approve_history (
	approve_type string,
	email_id bigint,
	ext_company_id bigint, 
